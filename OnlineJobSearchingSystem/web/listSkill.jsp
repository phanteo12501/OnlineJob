<%-- 
  ...
  10-09-2021    1.0        TungDT          First Deploy<br>
--%>
    ...
    <body>
        ...
        <main id="main">
            ...
            <section id="team" class="team section-bg">
                <form class="form" action="SearchSkillPublicController" method="GET">
                    <div class="row">
                        ...
                        <c:choose>
                            <c:when test="${name!=null}">
                                <div class="col-md-3">
                                    <label class="label" for="name">Search Skill by Name </label>
